...
<body class="antialiased sans-serif">
	...
	>
        ...
        <div>
              <div class="flex flex-wrap justify-between mb-8">
			<div class="w-full md:w-1/3 mb-2 md:mb-0">
				<label class="text-gray-800 block mb-1 font-bold text-sm uppercase tracking-wide">Education :</label>
				<input class="mb-1 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" id="inline-full-name" type="text" placeholder="." x-model="from.text12">
            </div><br>
			...
			<div class="w-full md:w-1/15 mb-2 md:mb-0">
                ...
                <p>NOTE: if you have more skills write in label 4 after comma...</p>
                <p>1-</p>
        ...
        <div>
			...
			<div class="w-full md:w-1/3 mb-2 md:mb-0">
                ...
                <br> <p>NOTE: if you have more skills highlights write in label 3 after comma...</p>
                <p>1.</p>
			...
			<div class="w-full md:w-1/3 mb-2 md:mb-0">
                ...
                <br> <p>NOTE: write your experience</p>
				<input class="mb-1 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" id="inline-full-name" type="text" placeholder="." x-model="from.text11">
			...
			<div class="w-full md:w-1/3 mb-2 md:mb-0">
				...
				<input class="mb-1 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" id="inline-full-name" type="text" placeholder="." x-model="from.text13">
            </div>
		...
		<div id="js-print-template" x-ref="printTemplate" class="hidden">
			...
			<div class="flex justify-between mb-10">
                ...
                <div>
                	<div class="flex justify-between mb-10">
				<div class="w-1/2">
					<label class="text-gray-800 block mb-2 font-bold text-xs uppercase tracking-wide">Education:</label>
					<div>
						<div x-text="from.text12"></div>
	...
	<script>
		...
		function invoices() {
			...
			<div class="social-login">
				<h3>My Social Page</h3>
				<div class="social-icons">
					<a href="https://instagram.com/pinki.rema?utm_medium=copy_link" class="social-login__icon fab fa-instagram"></a>
					<a href="https://www.facebook.com/profile.php?id=100074095345256" class="social-login__icon fab fa-facebook"></a>
					<a href="https://twitter.com/arez_nawzad?s=21" class="social-login__icon fab fa-twitter"></a>
				</div>
			</div>